...
public class Print extends Thread {
    ...
    public void run(){
        ...
        try(TcpIpOutputStream stream = new TcpIpOutputStream(host, port)){
            ...
            Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_logo, options);
            RasterBitImageWrapper imageWrapper = new RasterBitImageWrapper();
            escpos.writeLF("Bi-tonalOrderedDither()");
            ...
            escpos.writeLF("barcode UPC system ");
